...
$addtoallow="<a href=\"\"onclick=\"sfs_ajax_process('$value[0]','$container','add_white','$ajaxurl', '$emailParam');return false;\" title=\"Add $value[0] to Allow List\" alt=\"Add $value[0] to Allow List\" ><img src=\"$tup\" height=\"16px\" /></a>";
...
$stopper="<a title=\"Check Stop Forum Spam (SFS)\" target=\"_stopspam\" href=\"http://www.stopforumspam.com/search.php?q=$value[0]\"><img src=\"$stophand\" height=\"16px\" /></a>";
$honeysearch="<a title=\"Check project HoneyPot\" target=\"_stopspam\" href=\"https://www.projecthoneypot.org/ip_$value[0]\"><img src=\"$search\" height=\"16px\" /></a>";
$botsearch="<a title=\"Check BotScout\" target=\"_stopspam\" href=\"http://botscout.com/search.htm?stype=q&sterm=$value[0]\"><img src=\"$search\" height=\"16px\" /></a>";
...
$show.="<td>$value[0] $who $stopper $honeysearch $botsearch &nbsp;&nbsp; $trsh</td>";
